...
def simulator_status():
    return {
        ...
        "database_down": simulator_state.database_down,
    }
...
@router.post("/database-down/{enabled}")
def set_database_down(enabled: bool):
    simulator_state.database_down = enabled
    return simulator_status()
...
def reset_simulator():
    ...
    simulator_state.database_down = False
    return simulator_status()
